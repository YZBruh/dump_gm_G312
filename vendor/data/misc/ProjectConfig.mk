...
#prize modify by linchong 20210902 start
...
CUSTOM_HAL_IMGSENSOR = hi1336_mipi_raw gc8034sub_mipi_raw gc08a3sub_mipi_raw
#prize modify by linchong 20210902 end
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_IMGSENSOR = hi1336_mipi_raw
CUSTOM_HAL_MSENSORLIB = akl akm
CUSTOM_HAL_SENSORS = sensor
CUSTOM_HAL_SUB_IMGSENSOR = gc8034sub_mipi_raw gc08a3sub_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR = hi1336_mipi_raw gc8034sub_mipi_raw gc08a3sub_mipi_raw
#prize modify by linchong 20210902 end
...
CUSTOM_KERNEL_MAIN_IMGSENSOR = hi1336_mipi_raw
...
CUSTOM_KERNEL_SUB_IMGSENSOR = gc8034sub_mipi_raw gc08a3sub_mipi_raw
...
CUSTOM_MODEM=K6520S2GM-LWTG_6177M_R3_6762-4M-G4W1258F12357820TDD384041-V0.1
...
MTK_TOUCHPANEL_FIRMWARE = GCORE
#屏幕密度
PRIZE_LCD_DENSITY=320
#finger tee
PRIZE_FINGER_PRINT = ft9362_tee

PRIZE_SW_VERSION=K6520.GB.HDJ.R0.$(PRIZE_FLASH_CODE).$(shell date +%m%d_%H%M).V1.01.selfota
#---------------------------工厂测试----------------------------------
...
PRIZE_OTG_TEST = yes
#频段配置根据ProjectConfig.mk文件中的 MTK_PROTOCOL1_RAT_CONFIG 系统频段配置
...
#大于等于2颗前摄 无效
#PRIZE_FACTORY_TEST_REAR_CAMERA_FRONT_SUB2 = no
